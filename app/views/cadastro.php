<?php
// Arquivo: app/Views/cadastro.php (Página de Cadastro de Cliente)

// Simulação: Defina o título da página
...
// O script dashboard.js será substituído pelo cadastro.js, que será importado no footer.
